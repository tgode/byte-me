...
- `qwen2.5-coder` — HR answer generation (multilingual)
...
curl http://localhost:11434/api/chat \
  -d '{"model":"qwen2.5-coder","messages":[{"role":"user","content":"What is vacation policy?"}],"stream":false}'
```
